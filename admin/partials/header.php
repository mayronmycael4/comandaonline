...
<link rel="stylesheet" href="../assets/ui-shell.css?v=<?= filemtime(__DIR__.'/../../assets/ui-shell.css') ?>">
<script defer src="../assets/ui-shell.js?v=<?= filemtime(__DIR__.'/../../assets/ui-shell.js') ?>"></script>
</head>
<body>
<div class="topbar">
    <div>

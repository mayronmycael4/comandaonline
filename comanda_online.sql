...
-- Tabela: Histórico de Clientes (compras)
...
-- Tabela: Lista de Compras (itens faltantes)
...
-- Tabela: Sessões (opcional, para controle de login)
...
-- Insert usuário admin padrão (senha: admin123)

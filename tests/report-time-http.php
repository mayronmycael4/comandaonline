...
$actual = json_decode(file_get_contents($base.'api/relatorios.php?tipo=periodo&inicio=2026-05-01&fim=2026-09-14'), true, 512, JSON_THROW_ON_ERROR);
...
foreach (['api/auditoria.php?inicio=2026-02-30&fim=2026-03-01', 'api/relatorios.php?tipo=periodo&inicio=2026-09-12&fim=2026-09-11'] as $route) {

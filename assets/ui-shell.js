...
function init(){
 ...
 if(!admin&&typeof Storage==='undefined'&&storageWaitAttempts<20){storageWaitAttempts++;setTimeout(init,25);return;}
 ...
 if(can('comandas'))items.push({href:'pdv.html',label:'PDV'});
...
if(document.body) init(); else document.addEventListener('DOMContentLoaded',()=>queueMicrotask(init),{once:true});
})();

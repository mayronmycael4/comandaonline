...
function renderAtalhosGestaoDesktop() {
    ...
    const links = [
        { permission: 'produtos', href: 'produtos.html', label: 'Produtos', desc: 'Cadastrar e editar produtos', icon: '🍔' },
        { permission: 'estoque', href: 'estoque.html', label: 'Estoque', desc: 'Controle e lista de compras', icon: '📦' },
        ...
        { permission: 'relatorios', href: 'relatorios.html', label: 'Relatórios', desc: 'Financeiro e desempenho', icon: '📈' },
        { permission: 'funcionarios', href: 'funcionarios.html', label: 'Funcionários', desc: 'Usuários e permissões', icon: '👥' }

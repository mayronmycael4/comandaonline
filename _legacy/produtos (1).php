...
switch ($method) {
    ...
    case 'POST':
        ...
        $stmt = $pdo->prepare("INSERT INTO produtos (nome, categoria, preco, descricao) VALUES (?, ?, ?, ?)");
        $stmt->execute([
            $data['nome'],
            $data['categoria'],
            $data['preco'],
    ...
    case 'PUT':
        ...
        $stmt = $pdo->prepare("UPDATE produtos SET nome = ?, categoria = ?, preco = ?, descricao = ? WHERE id = ?");
        $stmt->execute([
            $data['nome'],
            $data['categoria'],
            $data['preco'],

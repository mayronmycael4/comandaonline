(function (global) {
    ...
    const DESKTOP_MENU_ITEMS = [
        ...
        { href: 'mesas-mapa.html', label: 'Mesas', icon: '\uD83D\uDDFA', permission: 'dashboard' },
    ...
    function ensureHeaderLogo() {
        ...
        brand.innerHTML = `
            <div class="brand-logo-wrap">
                <img src="logo-espetaria.jpeg" alt="Logo Espetaria Oliveira" class="brand-logo" width="52" height="52">
            </div>
            <div class="brand-text-wrap">
                <span class="brand-title">Espetaria Oliveira</span>
